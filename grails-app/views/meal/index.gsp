	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="create" action="create"><g:message code="default.new.labell" default="Dodaj posiłek" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="list-meal" class="content scaffold-list" role="main">
			<h1><g:message code="default.list.labell" default="Lista posiłków" args="[entityName]" /></h1>
